export const fakabase = {
	...
	home_page_data: {
		1: {
			background_image: "url('/images/light-blur.jpg')",
			top_header: "Fat Lady Baubles",
			main_header: "No Need<br />Call Me Sir",
			tag: "It is the unknown we fear when we look upon death and darkness nothing more. <br />",
			image: "./images/light-book.jpeg"
		},
		2: {
			background_image: "url('/images/light-book.jpeg')",
			top_header: "Unknown Fear",
			main_header: "Think For Yourself<br />Keep your Brain",
			tag: "It is our choices Harry that show what we truly are far more than our abilities <br />",
			image: "./images/man_light.png"
		},
		3: {
			background_image: "url('/images/man_light.png')",
			top_header: "Never Trust Anything",
			main_header: "Death And Darkness<br />Nothing More",
			tag: "Of course it is happening inside your head <br />",
			image: "./images/forest-walk-through.jpg"
		},
		4: {
			background_image: "url('/images/forest-walk-through.jpg')",
			top_header: "Thats The Spirit.",
			main_header: "Emotional Range<br />Of a Teaspoon",
			tag: "She needs to sort out her priorities until the very end. <br />",
			image: "./images/light-blur.jpg"
		},
		5: {
			background_image: "url('/images/light-blur.jpg')",
			top_header: "Teaspoon of Emotion",
			main_header: "How Very<br />Irritating",
			tag: "You sort of start thinking anythings possible if youve got enough nerve. <br />",
			image: "./images/wood-map.jpeg"
		},
		6: {
			background_image: "url('/images/wood-map.jpeg')",
			top_header: "Influencing Injury",
			main_header: "I'm Not Going<br />To Be Murdered",
			tag: "It takes a great deal of bravery to stand up to our enemies but just as much to stand up to our friends <br />",
			image: "./images/man_light.png"
		},
		7: {
			background_image: "url('/images/man_light.png')",
			top_header: "Happiness Can Be Found",
			main_header: "Old Pudding<br />I Am Not Ashamed",
			tag: "Never be ashamed my ol dad used ter say theres some wholl hold it against you <br />",
			image: "./images/wood-map.jpeg"
		},
	}
}

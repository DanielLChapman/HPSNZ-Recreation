...
export default class Video extends Component {
	...
	componentDidMount() {
		var videoJscii = new window.Jscii({
	...
	render() {
		return (
			<div className="video-display">
				<video id="jscii-element-video" width="150" height="112" controls loop autoPlay muted>
					<source src="./videos/Boo-test.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"' />
